...
export default function EditProfileScreen() {
  ...
  // Raw GPS coordinates from the last successful "Konumu bul" tap this
  // session - sent along on Kaydet so the backend can compute a real
  // distance to other people (see backend/src/geo.js). Null until detected;
  // handleSave only includes it in the patch when it's actually set, so
  // saving OTHER fields (bio, tags, etc.) without re-detecting location
  // never touches the coordinates already stored from a previous save.
