...
// Filled in with the actual data controller (Burak Tüfekçi, şahıs işletmesi)
// and contact e-mail below - no bracketed placeholders left. That said, this
// text was drafted as a reasonable starting point, not reviewed by a lawyer;
// 6698 sayılı KVKK compliance for a real, live user base is a legal question
// worth an actual sign-off, not something a generic template can guarantee.
